(function($){
        ...
        var zgpbld_f_html = function(element, options){
            var elem = $(element);
            var obj_main = this;
             var obj_quick_options = null;
            var field_obj_inp_html;
            var field_obj_inp_html2;
            var defaults = {
                            data:{
                                type: 8,
                                id: '',
           ...
           var settings = $.extend(true,{}, defaults, {data:options});
                        ...
                        this.setOptionsToModal = function(vars){
                            ...
                            switch(String(opt1)) {
                               case 'input1':
                                     switch(String(opt2)) {
                                            case 'text':
                                                var tmp_txt=zgpbld_back_helper.html_entity_decode(decodeURIComponent(opt4));
                                               field_obj_inp_html.getDoc().setValue(tmp_txt);
                                           ...
                                           case 'custom_css':
                                                switch(String(opt3)) {
                                                             ...
                                                             case 'ctm_additional':
                                                                 ...
                                                                 var tmp_txt2=decodeURIComponent(opt4);
                                                                    field_obj_inp_html2.getDoc().setValue(tmp_txt2);
                                ...
                                case 'input1':
                                     switch(String(opt2)) {
                                            case 'text':
                                                ...
                                                if(zgpbld_back_helper.isURIComponentEncoded(opt4)){
                                                  tmp_txt=zgpbld_back_helper.html_entity_decode(decodeURIComponent(opt4));
                                                }
 
                                                 tmp_txt=zgpbld_back_helper.filter_content_html(tmp_txt);
            ...
            console.error("error setOptionsToPreview ", ex.message);
        } 
                        }
                      ...
                      this.refresh_quickopt_position = function(){
                        ...
                        this.setDataToCore =function(tmp_vars){
                            ...
                            switch(String(f_opt1)){
                                case 'input1':
                                    zgpb_core.setUiData4('fields_src',String(id),String(f_opt1),String(f_opt2),encodeURIComponent(zgpbld_back_helper.htmlEntities(f_opt4)));
                                    break;
                                case 'max_width':   
                                case 'max_width_st':
                                case 'obj_align':
                        ...
                        this.enableSettingOptions_process =function(f_data,update_modal,update_preview){
                          ...
                          if(update_modal){  
                                ...
                                var te_html = document.getElementById("zgpb-field-fhtml-htmlsrc");
                               field_obj_inp_html = window.field_obj_inp_html = CodeMirror.fromTextArea(te_html, {
                                 mode: "text/html",
                                 htmlMode: true,
                                 lineNumbers: true,
                                 lineWrapping: true,
                               ...
                               field_obj_inp_html2 = window.field_obj_inp_html2 = CodeMirror.fromTextArea(te_html2, {
                                 mode : "css",
                                 htmlMode: true,
                                 lineNumbers: true,
                                 lineWrapping: true,
                              ...
                              modal_box.on( 'shown.bs.tab', 'a[data-toggle="tab"]', function (e) {
                                    field_obj_inp_html2.refresh();
                                 });
                              
                              field_obj_inp_html2.on("change", function(cm) {
                                   var f_store='skin-custom_css-ctm_additional';
                                     var f_val=cm.getValue();
                                     zgpb_core.updateModalFieldCoreAndPreview(f_store,f_val);
                               });
                           }
        ...
        $.fn.zgpbld_f_html = function(options){
            return this.each(function(){
            var element = $(this);

            // Return early if this element already has a plugin instance
            if (element.data('zgpbld_f_html')) return;

            // pass options to plugin constructor
            var myplugin = new zgpbld_f_html(this, options);

            // Store plugin object in this element's data
            element.data('zgpbld_f_html', myplugin);
            });
        };
})($zgpb);
