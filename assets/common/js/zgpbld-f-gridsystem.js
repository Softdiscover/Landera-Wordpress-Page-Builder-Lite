            ...
            var privateMethod = function(){
                       ...
                       var cur_el_obj;
                        ...
                        this.update_settingsData =function(options){
                          ...
                          settings = $.extend(true,{}, settings, {data:options});
                        ...
                        this.setDataToCore =function(tmp_vars){
                            ...
                            var id=tmp_vars['id'],
                              ...
                              if(parseInt(block)>0){
                                  ...
                                  zgpb_core.setUiData7('fields_src',String(id),'blocks',block_index,String(f_opt1),String(f_opt2),String(f_opt3),f_opt4);
                              }else{
                                   
                                  zgpb_core.setUiData6('fields_src',String(id),'main',String(f_opt1),String(f_opt2),String(f_opt3),f_opt4);
                              }
                                                                        ...
                                                                        $.each(value5, function(index6, value6) {
                                                                                if($.isPlainObject(value6)){
                                                                                    $.each(value6, function(index7, value7) {
                                                                                        ...
                                                                                        //tmp_vars['block']=(addt)?addt['block']:0;
                                                                                        //tmp_vars['block']=(addt)?addt['block']:0;
